...
from pipeline.adapters.llm_skills.domain_classification import DomainClassificationSkill
...
from pipeline.adapters.llm_skills.type_classification import TypeClassificationSkill
...
def test_extraction_returns_at_least_one_draft():
    client = OllamaClient("http://localhost:11434")
    skill = ExtractionSkill(client, CHAT_MODEL)
...
def test_type_classification_reuses_known_type():
    client = OllamaClient("http://localhost:11434")
    skill = TypeClassificationSkill(client, CHAT_MODEL)
    draft = DraftConcept(
...
def test_domain_classification_with_no_domains_returns_none():
    client = OllamaClient("http://localhost:11434")
    skill = DomainClassificationSkill(client, CHAT_MODEL)
    draft = DraftConcept(
...
def test_quality_eval_scores_a_grounded_draft():
    client = OllamaClient("http://localhost:11434")
    skill = QualityEvalSkill(client, CHAT_MODEL)
...
def test_prerequisite_skill_returns_one_score_per_rubric_per_candidate():
    ...
    client = OllamaClient("http://localhost:11434")
    skill = PrerequisiteJudgementSkill(client, CHAT_MODEL)
    candidates = [
...
def test_prerequisite_skill_short_circuits_without_rubrics_or_candidates():
    ...
    skill = PrerequisiteJudgementSkill(OllamaClient("http://localhost:11434"), CHAT_MODEL)
